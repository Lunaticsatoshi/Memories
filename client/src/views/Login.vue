    ...
    <div class="flex justify-center items-center">
      <div class="flex max-w-4xl">
        <div class="bg-white w-1/2 p-8">
            <h1 class="text-gray-700 text-3xl">Login</h1>
            <div class="my-3">
            ...
            <div class="my-3">
                <button class="rounded-full bg-blue-600 border-blue-600 px-8 py-2 text-white">Login</button>
            </div>
        </div>
        <div class="w-1/2">
            <img src="https://images.unsplash.com/photo-1534531688091-a458257992cb?ixlib=rb-1.2.1&ixid=MXwxMjA3fDB8MHxzZWFyY2h8NXx8bWVtb3JpZXN8ZW58MHx8MHw%3D&auto=format&fit=crop&w=500&q=60" alt="Login">
        </div>
      </div>
    </div>
  </div>
